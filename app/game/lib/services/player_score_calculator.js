PlayerScoreCalculator = class PlayerScoreCalculator {
  ...
  constructor(player_cards) {
    ...
    this.card_sources = ['hand', 'discard', 'deck', 'in_play', 'revealed', 'haven', 'native_village', 'island', 'save', 'gear', 'tavern', 'prince', 'princed', 'horse_traders', 'faithful_hounds', 'estate', 'encampments', 'archive', 'ghost', 'crypt']
  }
