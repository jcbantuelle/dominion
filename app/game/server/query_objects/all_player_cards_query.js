AllPlayerCardsQuery = class AllPlayerCardsQuery {
  ...
  static card_sources() {
    return ['hand', 'discard', 'deck', 'playing', 'in_play', 'revealed', 'duration', 'haven', 'native_village', 'island', 'horse_traders', 'faithful_hounds', 'to_discard', 'discarding', 'prince', 'princed', 'tavern', 'permanent', 'gear', 'save', 'estate', 'encampments', 'archive']
  }
