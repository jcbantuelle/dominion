...
function createPopovers() {
  $('body').popover({
    selector: '.card-container .card, .event-container .card, .hand-card, .prize-card, .black-market-card, .choose-card, .landmark-container .card, .boon-container .card, #game-log span.boon, #game-log span.hex, #game-log span.state, #action-response span.boon, #action-response span.hex',
    html: true,
    content: function() {
